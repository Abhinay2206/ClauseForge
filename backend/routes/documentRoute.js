...
const { getUploadUrl, registerDocument, getDocuments, getDocumentAnalysis, compareDocuments, explainClause, downloadDocumentReport, getDocumentReport, negotiateDocument, documentActionItems, getAllActionItems, deleteDocument, getComparisons, getComparisonById } = require('../controllers/documentController');
